...
export function pathwaySystemPrompt() {
  return [
    ...
    '     "city": "City, ST", "address": "<full street address>" | null,',
    '     "note": "...one short sentence...", "url": "..." | null,',
    ...
    "11. For every concrete facility (type != 'Category'), include the FULL STREET ADDRESS in the `address` field — number, street, city, ST, ZIP. USE Google Search to verify the address matches the named facility (check the official site or Google Maps). The downstream cinematic geocodes the address to drop the camera on the actual building, so accuracy is critical. If you can't verify the address with high confidence, set address=null and the system will fall back to your lat/lng approximation. DO NOT fabricate addresses.",
    "",
    "TONE:",
