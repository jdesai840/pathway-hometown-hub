...
export default function HubDetail() {
  ...
  return (
    <aside
      ...
      className="fixed top-16 right-4 bottom-4 w-[360px] max-w-[40vw] rounded-2xl bg-slate-900/95 border border-slate-700 backdrop-blur p-5 overflow-y-auto z-30 shadow-2xl"
    >
